...
namespace OutageProjectDLL.OutageProjectsDataSetTableAdapters {
    ...
    public partial class outageprojectsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[outageprojects] ([CreatedDate], [CreatedUser], [ModifiedDate], [ModifiedUser], [OutageDate], [TempDID], [ProjectID], [OutageAddress1], [OutageAddress2], [OutageCity], [OutageState], [OutagePostalCode]) VALUES (@CreatedDate, @CreatedUser, @ModifiedDate, @ModifiedUser, @OutageDate, @TempDID, @ProjectID, @OutageAddress1, @OutageAddress2, @OutageCity, @OutageState, @OutagePostalCode);
SELECT TransactionID, CreatedDate, CreatedUser, ModifiedDate, ModifiedUser, OutageDate, TempDID, ProjectID, OutageAddress1, OutageAddress2, OutageCity, OutageState, OutagePostalCode FROM outageprojects WHERE (TransactionID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[outageprojects] SET [CreatedDate] = @CreatedDate, [CreatedUser] = @CreatedUser, [ModifiedDate] = @ModifiedDate, [ModifiedUser] = @ModifiedUser, [OutageDate] = @OutageDate, [TempDID] = @TempDID, [ProjectID] = @ProjectID, [OutageAddress1] = @OutageAddress1, [OutageAddress2] = @OutageAddress2, [OutageCity] = @OutageCity, [OutageState] = @OutageState, [OutagePostalCode] = @OutagePostalCode WHERE (([TransactionID] = @Original_TransactionID) AND ([CreatedDate] = @Original_CreatedDate) AND ([CreatedUser] = @Original_CreatedUser) AND ((@IsNull_ModifiedDate = 1 AND [ModifiedDate] IS NULL) OR ([ModifiedDate] = @Original_ModifiedDate)) AND ((@IsNull_ModifiedUser = 1 AND [ModifiedUser] IS NULL) OR ([ModifiedUser] = @Original_ModifiedUser)) AND ([OutageDate] = @Original_OutageDate) AND ([ProjectID] = @Original_ProjectID) AND ([OutageCity] = @Original_OutageCity) AND ([OutageState] = @Original_OutageState) AND ([OutagePostalCode] = @Original_OutagePostalCode));
SELECT TransactionID, CreatedDate, CreatedUser, ModifiedDate, ModifiedUser, OutageDate, TempDID, ProjectID, OutageAddress1, OutageAddress2, OutageCity, OutageState, OutagePostalCode FROM outageprojects WHERE (TransactionID = @TransactionID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TransactionID, CreatedDate, CreatedUser, ModifiedDate, ModifiedUser, Outag" +
                ...
                "te, OutagePostalCode FROM dbo.outageprojects";
        ...
        public virtual int Delete(int Original_TransactionID, System.DateTime Original_CreatedDate, string Original_CreatedUser, global::System.Nullable<global::System.DateTime> Original_ModifiedDate, string Original_ModifiedUser, System.DateTime Original_OutageDate, int Original_ProjectID, string Original_OutageCity, string Original_OutageState, string Original_OutagePostalCode) {
        ...
        public virtual int Update(
            ...
            if ((Original_CreatedUser == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_CreatedUser));
            }
            if ((Original_ModifiedDate.HasValue == true)) {
            ...
            if ((Original_ModifiedUser == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_ModifiedUser));
            }
            this.Adapter.UpdateCommand.Parameters[19].Value = ((System.DateTime)(Original_OutageDate));
            this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_ProjectID));
            if ((Original_OutageCity == null)) {
                throw new global::System.ArgumentNullException("Original_OutageCity");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_OutageCity));
            }
            if ((Original_OutageState == null)) {
                throw new global::System.ArgumentNullException("Original_OutageState");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_OutageState));
            }
            if ((Original_OutagePostalCode == null)) {
                throw new global::System.ArgumentNullException("Original_OutagePostalCode");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_OutagePostalCode));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_OutageState, 
                    string Original_OutagePostalCode) {
            return this.Update(CreatedDate, CreatedUser, ModifiedDate, ModifiedUser, OutageDate, TempDID, ProjectID, OutageAddress1, OutageAddress2, OutageCity, OutageState, OutagePostalCode, Original_TransactionID, Original_CreatedDate, Original_CreatedUser, Original_ModifiedDate, Original_ModifiedUser, Original_OutageDate, Original_ProjectID, Original_OutageCity, Original_OutageState, Original_OutagePostalCode, Original_TransactionID);
        }
    }
